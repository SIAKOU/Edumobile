...
class ScheduleRepository {
  ...
  Future<List<Map<String, dynamic>>> getSchedules({String? classId, String? studentId}) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint('ScheduleRepository: Unexpected data format for getSchedules: ${response.body}');
        return [];
      } else {
        // Log non-success status code
        debugPrint('ScheduleRepository: Failed to get schedules. Status code: ${response.statusCode}, Body: ${response.body}');
      }
    } catch (e) {
  ...
  Future<Map<String, dynamic>?> getScheduleById(String scheduleId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint('ScheduleRepository: Failed to get schedule by ID $scheduleId. Status code: ${response.statusCode}, Body: ${response.body}');
      }
    } catch (e) {
      debugPrint('ScheduleRepository: Exception during getScheduleById $scheduleId: $e');
    }
    return null;
  }
  ...
  Future<bool> createSchedule(Map<String, dynamic> scheduleData) async {
    try {
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        debugPrint('ScheduleRepository: Failed to create schedule. Status code: ${response.statusCode}, Body: ${response.body}');
      }
    } catch (e) {
  ...
  Future<bool> updateSchedule(String scheduleId, Map<String, dynamic> updateData) async {
    try {
      final response = await apiClient.put('/schedules/$scheduleId', body: updateData);
      if (response.statusCode == 200) {
        return true;
      } else {
        debugPrint('ScheduleRepository: Failed to update schedule $scheduleId. Status code: ${response.statusCode}, Body: ${response.body}');
      }
    } catch (e) {
      debugPrint('ScheduleRepository: Exception during updateSchedule $scheduleId: $e');
    }
    return false;
  }
  ...
  Future<bool> deleteSchedule(String scheduleId) async {
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        debugPrint('ScheduleRepository: Failed to delete schedule $scheduleId. Status code: ${response.statusCode}, Body: ${response.body}');
      }
    } catch (e) {
      debugPrint('ScheduleRepository: Exception during deleteSchedule $scheduleId: $e');
    }
    return false;
  }
}
